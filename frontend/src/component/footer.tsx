...
const Footer: React.FC = () => {
    return (
        <footer className="fixed bottom-0 bg-gray-900 text-gray-400 py-6 px-8 flex flex-col md:flex-row md:items-center justify-between rounded-t-lg z-50 w-full">
