...
const Footer: React.FC = () => {
    return (
        <footer className="bg-gray-900 text-gray-400 py-6 px-8 flex flex-col md:flex-row items-center justify-between rounded-t-lg z-50 fixed bottom-0 w-full h-10">
            {/* Copyright */}
